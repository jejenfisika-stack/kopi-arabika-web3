...
import KartuEtika from './KartuEtika'
...
export const L = {
  id: {
    ...
    labTitle: '🧪 Lab',
    labSub: 'Lima laboratorium untuk diutak-atik: ubah sesuatu, lalu amati akibatnya. Semuanya berjalan di peramban.',
    navLab: [['dasar','🔬 Hash & Entropi'],['blockchain','⛓️ Lab Blockchain'],['konvolusi','🔍 Lab Konvolusi'],['batas','🧪 Uji Batas Model']],
    navBelajar: [['ct','🧩 Cara Kerja Sistem'],['lkpd','📝 LKPD Predict-Observe-Explain'],['etika','⚖️ Kartu Dilema Etika'],['cam','🔥 Panduan Grad-CAM'],['kuis','🤖 Kuis AI Literacy'],['gloss','📚 Glosarium']],
  ...
  en: {
    ...
    labTitle: '🧪 Lab',
    labSub: 'Five hands-on laboratories: change something, then watch what happens. Everything runs in your browser.',
    navLab: [['dasar','🔬 Hash & Entropy'],['blockchain','⛓️ Blockchain Lab'],['konvolusi','🔍 Convolution Lab'],['batas','🧪 Model Boundary Lab']],
    navBelajar: [['ct','🧩 How It Works'],['lkpd','📝 Predict-Observe-Explain Worksheet'],['etika','⚖️ Ethics Dilemma Cards'],['cam','🔥 Grad-CAM Guide'],['kuis','🤖 AI Literacy Quiz'],['gloss','📚 Glossary']],
...
export default function Belajar({ lang, hasilCNN, gradcam, onLkpdStatus }) {
  const t = L[lang] || L.id
  ...
  return (
    <section className="section" id="belajar">
      ...
      <div id="bg-lkpd"><LKPD lang={lang} hasil={hasilCNN} gradcam={gradcam} onStatus={onLkpdStatus} /></div>

      <div id="bg-etika"><KartuEtika lang={lang} /></div>
